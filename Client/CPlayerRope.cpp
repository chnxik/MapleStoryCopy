...
void CPlayerRope::KeyInput(CPlayer* player)
{
...
void CPlayerRope::Update(CPlayer* player)
{
	...
	if (player->GetAnimator()->GetCurAnimation()->IsStop() && !(player->IsInvincible()))
		player->GetAnimator()->Play(L"rope", true);
}

void CPlayerRope::Enter(CPlayer* player)
{
	if (player->IsInvincible())
		player->GetAnimator()->Play(L"rope", true, FLASHGVALUE, true);
	else
		player->GetAnimator()->Play(L"rope", true);
	player->ZeroJumpCnt();
...
void CPlayerRope::Exit(CPlayer* player)
{
